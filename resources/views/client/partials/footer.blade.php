            ...
            <div class="main-footer">
                <div class="row g-md-4 gy-sm-5">
                    ...
                    <div class="col-xxl-2 col-xl-4 col-sm-6">
                        ...
                        <ul class="footer-list footer-list-light footer-contact">
                            <li>
                                <a href="vegetables-demo.html" class="light-text">Rau củ tươi</a>
                            </li>
                            <li>
                                <a href="spice-demo.html" class="light-text">Gia vị cay</a>
                            </li>
                            <li>
                                <a href="bags-demo.html" class="light-text">Túi mới về</a>
                            </li>
                            <li>
                                <a href="bakery-demo.html" class="light-text">Bánh mới ra lò</a>
                            </li>
                            <li>
                                <a href="grocery-demo.html" class="light-text">Tạp hóa mới</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)" class="light-text">
                                    <div class="inform-box">
                                        ...
                                        <p>Email: Support@Fastkart.com</p>
                                    </div>
                                </a>
                            </li>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="{{ asset('client/theme/themes.pixelstrap.com/fastkart/assets/images/product/category/1.jpg') }}" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="right-sidebar-modal">
                                <h4 class="title-name">Bánh quy bơ đậu phộng cao cấp 600 g</h4>
                                ...
                                <div class="product-rating">
                                    ...
                                    <span class="ms-2 text-danger">Đã bán 6 sản phẩm trong 16 giờ qua</span>
                                </div>

                                <div class="product-detail">
                                    <h4>Chi tiết sản phẩm :</h4>
                                    <p>Mô tả sản phẩm mẫu dùng để trình bày giao diện. Bạn có thể thay bằng nội dung thật của sản phẩm để hiển thị cho khách hàng.</p>
                                </div>
                                ...
                                <div class="select-size">
                                    ...
                                    <select class="form-select select-form-size">
                                        ...
                                        <option value="red">Hoa hồng đỏ</option>
                                        <option value="pink">Kèm hoa hồng hồng</option>
                                    </select>
                                </div>

                                <div class="modal-button">
                                    <button onclick="location.href = 'cart.html';"
                                        class="btn btn-md add-cart-button icon">Thêm
                                        vào giỏ hàng</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Chọn khu vực giao hàng</h5>
                    <p class="mt-1 text-content">Nhập địa chỉ của bạn và chúng tôi sẽ hiển thị ưu đãi phù hợp cho khu vực đó.</p>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="location-list">
                        <div class="search-input">
                            <input type="search" class="form-control" placeholder="Tìm khu vực của bạn">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        ...
                        <p class="mt-1 text-content">Gợi ý ưu đãi dành cho bạn.</p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="{{ asset('client/theme/themes.pixelstrap.com/fastkart/assets/images/vegetable/product/10.png') }}" class="blur-up lazyload"
                                            alt="">
                                    </a>

                                    <a href="shop-left-sidebar.html" class="deal-contain">
                                        <h5>Cà phê hòa tan 50 g mua 1 tặng 1</h5>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="{{ asset('client/theme/themes.pixelstrap.com/fastkart/assets/images/vegetable/product/11.png') }}" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="{{ asset('client/theme/themes.pixelstrap.com/fastkart/assets/images/vegetable/product/12.png') }}" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="{{ asset('client/theme/themes.pixelstrap.com/fastkart/assets/images/vegetable/product/13.png') }}" class="blur-up lazyload"
                                            alt="">
                                    </a>
